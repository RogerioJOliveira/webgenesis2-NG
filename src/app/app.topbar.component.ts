            ...
            <ul class="topbar-menu fadeInDown" [ngClass]="{'topbar-menu-visible': app.topbarMenuActive}">
                ...
                <li #search class="search-item" [ngClass]="{'active-topmenuitem':app.activeTopbarItem === search}"
                    ...
                    <span class="md-inputfield">
                        <input type="text" [(ngModel)]="filtro" pTooltip="Filtro: maior que 3 caracteres" 
                        pInputText (blur)="selectedNavItem(filtro)">
...
export class AppTopBar {
    ...
    constructor(@Inject(forwardRef(() => AppComponent)) public app: AppComponent, private _navService: NavtopobservService) {}
